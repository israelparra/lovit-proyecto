package proyectolovit.proyectolovit.services;
...
public class AlmacenServicioImpl implements AlmacenServicio{
    ...
    public void iniciarAlmacenDeArchivos() {
        try {
            ...
            throw new RuntimeException("Error al inicializar la ubicación en el almacen de archivos");
        }
    }
    ...
    public String almacenarArchivo(MultipartFile archivo) {
        ...
        try {
            ...
            throw new RuntimeException("Error al almacenar el archivo " + nombreArchivo,excepcion);
        }
